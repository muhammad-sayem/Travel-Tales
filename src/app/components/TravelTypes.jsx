    ...
    <div className="w-10/12 mx-auto py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6">
        <div className="flex flex-col items-center">
          <GiForest size={100} className="text-[#d0cfc2] hover:text-[#a4a291] transition-transform duration-300 hover:scale-105"/>
          <p className="my-2 text-xl font-black uppercase"> Adventure </p>
        </div>

        <div className="flex flex-col items-center">
          <GiCampingTent size={100} className="text-[#d0cfc2] hover:text-[#a4a291] transition-transform duration-300 hover:scale-105"/>
          <p className="my-2 text-xl font-black uppercase"> Camping </p>
        </div>

        <div className="flex flex-col items-center">
          <GiBirchTrees size={100} className="text-[#d0cfc2] hover:text-[#a4a291] transition-transform duration-300 hover:scale-105"/>
          <p className="my-2 text-xl font-black uppercase"> Wildlife </p>
        </div>

        <div className="flex flex-col items-center">
          <FaRoad size={100} className="text-[#d0cfc2] hover:text-[#a4a291] transition-transform duration-300 hover:scale-105"/>
          <p className="my-2 text-xl font-black uppercase"> Road Trip </p>
        </div>

        <div className="flex flex-col items-center">
          <IoCameraSharp size={100} className="text-[#d0cfc2] hover:text-[#a4a291] transition-transform duration-300 hover:scale-105"/>
          <p className="my-2 text-xl font-black uppercase"> Photography </p>
        </div>

        <div className="flex flex-col items-center">
          <IoBookOutline size={100} className="text-[#d0cfc2] hover:text-[#a4a291] transition-transform duration-300 hover:scale-105"/>
